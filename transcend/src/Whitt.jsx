  ...
  return (
    <div>
      <section className="sec1">
        ...
        <h3>Define</h3>
        <p>Quos dolores saepe mollitia deserunt accusamus autem reprehenderit. Voluptas facere animi explicabo non quis magni recusandae. Numquam debitis pariatur omnis facere unde. Laboriosam minus amet nesciunt est. Et saepe eos maxime tempore quasi deserunt ab.</p>
      ...
      <h2>/ What We Do</h2>
      <p>We have everything you need to launch and grow a successful digital business.</p>
